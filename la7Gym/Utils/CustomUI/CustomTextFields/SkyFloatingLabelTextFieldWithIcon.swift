...
open class SkyFloatingLabelTextFieldWithIcon: SkyFloatingLabelTextField {
    ...
    @IBInspectable
    dynamic open var iconWidth: CGFloat = GET_RATIO(15) {
        didSet {
            updateFrame()
        }
    }
     ...
     */
    @IBInspectable
    dynamic open var iconMarginLeft: CGFloat = GET_RATIO(4) {
        didSet {
            updateFrame()
        }
    }
     ...
     */
    @IBInspectable
    dynamic open var iconMarginBottom: CGFloat = GET_RATIO(4) {
        didSet {
            updateFrame()
        }
    }
    ...
    */
    ...
    fileprivate func createIconLabel() {
        ...
        self.iconFont = UIFont.systemFont(ofSize: 10)
